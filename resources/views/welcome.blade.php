...
<div id="galeria">
    <div class="row px-2">
        ...
        <div class="col-lg-4">
            <img src="{{asset('img/Default_blanco_y_negro_fotografia_personas_arte_artista_musica_2.jpg')}}" alt="">
        </div>
        <div class="col-lg-4">
            <img src="{{asset('img/Default_Pintura_pintor_blanco_y_negro_lienzo_acuarela_arte_bel_0.jpg')}}" alt="">
        </div>
        <div class="col-lg-4">
            <img src="{{asset('img/Default_blanco_y_negro_fotografia_personas_arte_artista_musica_0.jpg')}}" alt="">
        </div>
        <div class="col-lg-4">
            <img src="{{asset('img/Default_Pintura_pintor_blanco_y_negro_lienzo_acuarela_arte_bel_1.jpg')}}" alt="">
        </div>
        <div class="col-lg-4">
            <img src="{{asset('img/Default_Pintura_pintor_blanco_y_negro_lienzo_acuarela_arte_bel_3.jpg')}}" alt="">
        </div>
        <div class="col-lg-4">
            <img src="{{asset('img/Default_Pintura_pintor_blanco_y_negro_lienzo_acuarela_arte_bel_0 (1).jpg')}}" alt="">
        </div>
    </div>
</div>
